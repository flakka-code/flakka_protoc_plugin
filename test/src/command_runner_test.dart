...
import 'package:flakka_protoc_plugin/src/command_runner.dart';
...
void main() {
  group('FlakkaProtocPluginCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlakkaProtocPluginCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlakkaProtocPluginCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlakkaProtocPluginCommandRunner();
